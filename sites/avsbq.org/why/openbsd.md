<style>body { background: url(.pix/puf.gif) no-repeat; background-position: top right !important; background-attachment: fixed; background-size: 120px auto; /* Adjust the size as needed */ }</style>
